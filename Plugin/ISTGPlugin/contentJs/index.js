...
function createPage (originalTitle,desc) {
    ...
    $('body').append(page)
     ...
     $.ajax({
            ...
            type: "post",
            data: {
                IncompleteTitle: originalTitle,
                Desc: desc,
            },
            success: function (res) {
                console.log(res);
				AutoComplete("auto_div", "issue_title", res.title_List);
            },
            error: function (e) {
...
$(document).keydown(function (e) {
        if (e.ctrlKey && e.keyCode === 81) {
            print("start")
            var incompletetitle = document.getElementById('issue_title').value;
            // var body1 = document.getElementsByClassName('s-code-block markdown')[0].innerText;
            // var body2=document.getElementsByClassName('s-code-block markdown')[1].innerText;
            ...
            createPage(incompletetitle,body)
        }
    })